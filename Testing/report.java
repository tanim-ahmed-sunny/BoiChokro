...
public class webdriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2️⃣ Go to Reports tab
            driver.get("http://localhost/boi/admin/dashboard.php?tab=reports");

            // Wait until reports table or main element loads
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".table")));

            System.out.println("✅ Reports tab loaded successfully");
