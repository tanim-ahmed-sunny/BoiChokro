...
public class webdriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2️⃣ Go to Books tab
            driver.get("http://localhost/boi/admin/dashboard.php?tab=books");

            // Wait until books table or some element loads
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".table")));

            System.out.println("✅ Books tab loaded successfully");
