...
public class webdriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2️⃣ Go to Libraries tab
            driver.get("http://localhost/boi/admin/dashboard.php?tab=libraries");

            // Wait until libraries table or some element loads
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".table")));

            System.out.println("✅ Libraries tab loaded successfully");
