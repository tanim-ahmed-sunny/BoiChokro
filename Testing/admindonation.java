...
public class webdriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 2️⃣ Go to Donations tab
            driver.get("http://localhost/boi/admin/dashboard.php?tab=donations");

            // Wait until donations table or some element loads
            wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".table")));

            System.out.println("✅ Donations tab loaded successfully");
